...
### Windows
```powershell
Invoke-WebRequest -Uri https://github.com/dmnyu/bagit.net/releases/download/v0.2.3-alpha/bagit.net.cli-v0.2.3-alpha-win-x64.zip -OutFile bagit.net.cli-v0.2.3-alpha-win-x64.zip
Expand-Archive bagit.net.cli-v0.2.3-alpha-win-x64.zip -DestinationPath .
cd .\bagit.net
.\bagit.net.exe --help
.\install.ps1
